...
NUMERIC_FIELDS: tuple[NumericField, ...] = (
    ...
    NumericField("Побед над Змеем", "snake_wins", ("snake_wins", "serpent_wins")),
    NumericField("Побед над Владыкой", "lord_wins", ("lord_wins",)),
    ...
    NumericField("Ловкость", "dexterity", ("dexterity", "agility")),
    NumericField("Мастерство", "mastery", ("mastery",)),
    NumericField("Живучесть", "vitality", ("vitality",)),
    NumericField("Награбил (серебро)", "rob_silver", ("rob_silver", "silver_looted")),
    NumericField("Потерял (серебро)", "lost_silver", ("lost_silver", "silver_lost")),
    NumericField("Награбил (кристаллы)", "rob_crystals", ("rob_crystals", "crystals_looted")),
    NumericField("Потерял (кристаллы)", "lost_crystals", ("lost_crystals", "crystals_lost")),
